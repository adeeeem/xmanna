    ...
    <header className={`header ${menuOpenedClass}`}>
      ...
      >
        <div className="navbar-header">
          ...
          <Link style={{ color: '#dd3400' }} to="/" className="navbar-brand logo">
            <img src={Logo} alt="Logo" width="120" height="70" />
            {/* Xmana */}
          </Link>

          {/* <Link style={{ color: '#dd3400' }} to="/kyc" className="navbar-brand">
            KYC
          </Link> */}
        </div>
        ...
        <div className="main-menu-wrapper">
          <div className="menu-header">
            {/* <a style={{ color: '#dd3400' }} href="/" className="menu-logo">
          ...
          >
            ...
            <li className="login-link ">
              {/* <Link to="/dashboard" style={{ color: '#dd3400' }} > */}

                {localStorage.getItem("Address") ? (
                  <a href={"https://ropsten.etherscan.io/address/" + localStorage.getItem("Address")} target="_blank" rel="noopener noreferrer" style={{ color: '#dd3400' }}>
                    <span style={{ cursor: 'pointer' }}>{localStorage.getItem("Address").substr(0, 10)}. . .</span>
                  </a>
                ) : (
                  <>
                    <Link to="/login" style={{ color: '#dd3400' }} >
            ...
            <li>
              <Link to="/marketPlace" style={{ color: '#dd3400' }} >
            ...
            <li>
              <Link to="/auctionDrops" style={{ color: '#dd3400' }} >
