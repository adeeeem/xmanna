            ...
            <div className="page-wrapper">
                <div className="content container-fluid">
                                ...
                                <div className="card">
                                    <div className="card-body">
                                        <ul className="breadcrumb">
                                            <li className="breadcrumb-item active" style={{ color: "#dd3400" }}>User Name : {userData.username}</li>
                                        </ul>
                                        <ul className="breadcrumb">
                                            <li className="breadcrumb-item active" style={{ color: "#dd3400" }}> User Email : {userData.email}</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="container-fluid">
                        <div className="row">
                            <li className="menu-title" style={{ color: "#dd3400" }}>
                                <span>Main</span>
                            </li>
                        </div>
                        <div className="row">
                                    ...
                                    <div className="card">
                                        <CardActionArea>
                                            <div className="card-body">
                                                ...
                                                <div className="dash-widget-info">
                                                    <h6 className="text">Music Artist</h6>
                                                    <div className="progress progress-sm">
