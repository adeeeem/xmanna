                ...
                <div className="card-body">
                    ...
                    <div className="form-group" >
                        {open ? (
                            ...
                            <Card variant="outlined" style={{ padding: "40px", marginTop: '20px', marginBottom: '20px', color: "#ff0000" }}>
                            ...
                            <>
                                {cubeData.length !== 0 ? (
                                    <Typography  className="onsale1" style={{ marginTop: '20px', marginBottom: '20px' }} >
