                        ...
                        <div className="form-group" style={{ minHeight: '500px', marginTop: '120px' }}>
                            <div className="form-group">
                                ...
                                {open ? (
                                    ...
                                    <>
                                        {cubeData.length !== 0 ? (
                                            <Typography variant="h5" className="onsale" style={{ marginTop: '20px', marginBottom: '20px' }} >
                                                        ...
                                                        <Card style={{ height: "100%" }} variant="outlined" className={classes.root}>
                                                            ...
                                                            <CardActionArea>
                                                                ...
                                                                <CardContent>
                                                                    ...
                                                                    <Typography variant="h6" gutterBottom  style={{ color:'#000' }}  className="text-center">Music Artist</Typography>
                                        ...
                                        {cubeData.length !== 0 ? (
                                            <Typography variant="h5" className="onauct" style={{ marginTop: '20px', marginBottom: '20px' }} >
